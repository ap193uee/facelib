...
class YOLOBase(object):
    ...
    def __init__(self, model_name, basename, alpha, threshold, iou_threshold):
        self.alpha = alpha
...
class PersonDetectorYOLOTiny(YOLOBase):
    def __init__(self, model_name, basename='frontal-face', alpha=0.1, threshold=0.2, iou_threshold=0.5):
        self.alpha = alpha
        self.threshold = threshold
        self.iou_threshold = iou_threshold
        self.basename = basename
